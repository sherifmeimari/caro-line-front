...
import { categories, collections, products } from '../api/data';
                  ...
                  <div className="flex h-16 items-center justify-between">
                              ...
                              return (
                                <Popover key={collection.name} className="flex">
                                  <div className="relative flex">
                                    <PopoverButton className="group relative flex items-center justify-center text-sm font-medium transition-colors duration-200 ease-out cursor-pointer focus:outline-none focus:ring-0">
                                      {collection.name}
                                      <span
                                        aria-hidden="true"
                    ...
                    <div className="flex flex-1 items-center lg:hidden">
                      <button
                        ...
                        className="-ml-2 p-2 text-grey-900"
                      >
