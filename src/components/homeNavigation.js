      ...
      <div className="relative bg-gray-900 h-svh">
          ...
          <nav aria-label="Top">
            ...
            <div
              className={`transition-colors duration-200  backdrop-filter ${
                activeCollection ? 'bg-white' : 'bg-transparent'
              }`}
            >
              <div
                className={`mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ${
                  activeCollection !== null ? 'text-gray-900' : 'text-white'
                }`}
              >
                <div>
                  <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="hidden lg:flex lg:flex-1 lg:items-center">
                      <a href="#">
                        ...
                        <img
                          alt=""
                          src={`https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=${activeCollection ? 'black' : 'white'}`}
                                          ...
                                          <div className="relative bg-white">
                                            <div className="mx-auto max-w-7xl px-8">
                                              <div className="grid grid-cols-5 gap-x-8 gap-y-10 py-16">
                                                <div
                                                  key={collection.page.name}
                                                  className="group relative"
                                                >
                                                  <img
                                                    alt={
                                                      collection.page.imageAlt
                                                    }
                                                    src={
                                                      collection.page.imageSrc
                                                    }
                                                    className="aspect-square w-full rounded-md bg-gray-100 object-cover group-hover:opacity-75"
                                                  />
                                                  <a
        ...
        <div className="relative mx-auto flex max-w-3xl flex-col items-center px-6 py-32 text-center sm:py-64 lg:px-0">
          ...
          <p className="mt-4 text-xl text-white">
            You can try it on before buying it. Check out the latest options
            from our ready-to-wear dresses while they are still in stock.
          </p>
          <a
            href="#"
